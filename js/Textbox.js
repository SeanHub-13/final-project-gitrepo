class Textbox {
    ...
    textBox() {
        ...
        this.textWrite = this.scene.add.text(0, 0, this.text[this.currentText]["hint"], { fontFamily: "Palatino Linotype", fontSize: 20, color: '#ada41a', stroke: '#c92236', strokeThickness: 3, align: 'center', wordWrap: { width: this.box.width * 0.90 } }).setDepth(1001);
        this.nextR = this.scene.add.text(0, 0, "(R)", { fontFamily: "Palatino Linotype", fontSize: 18, color: '#ada41a', stroke: '#4287f5', strokeThickness: 3, align: 'center', wordWrap: { width: this.box.width * 0.90 } }).setDepth(1001);
        ...
        this.nextR.setY(this.box.y + 50 - this.nextR.height / 2);
